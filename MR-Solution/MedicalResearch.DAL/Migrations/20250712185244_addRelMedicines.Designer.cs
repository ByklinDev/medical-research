...
namespace MedicalResearch.DAL.Migrations
{
    ...
    [Migration("20250712185244_addRelMedicines")]
    partial class addRelMedicines
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedicalResearch.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Initials = "",
                            LastName = "Duchovny",
                            Password = "wP5ZlKFBMv4i/bFEsJohepRzLOJ97o9on2kHd3zB6pU=",
                            PasswordSalt = new byte[] { 40, 22, 77, 132, 160, 22, 170, 160, 79, 12, 138, 6, 70, 169, 29, 47, 238, 22, 146, 40, 200, 111, 116, 39, 199, 94, 5, 184, 215, 1, 208, 250 },
                            State = 0
                        });
                });
